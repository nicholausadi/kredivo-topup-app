...
internal enum Asset {
  ...
  internal enum Color {
    internal static let blueF4F8FE = ColorAsset(name: "blue_F4F8FE")
    internal static let gray535353 = ColorAsset(name: "gray_535353")
    internal static let grayAEAEAE = ColorAsset(name: "gray_AEAEAE")
    internal static let grayDCDCDC = ColorAsset(name: "gray_DCDCDC")
